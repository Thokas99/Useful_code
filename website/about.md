...
- `draft`, `validated`, and `blocked` describe strict notebook validation
  status. `SOURCE-BACKED` does not mean scientifically validated.
...
See the [repository README](https://github.com/Thokas99/Useful_code/blob/main/README.md), [archive](https://github.com/Thokas99/Useful_code/tree/main/archive), and [LICENSE](https://github.com/Thokas99/Useful_code/blob/main/LICENSE) on GitHub.
